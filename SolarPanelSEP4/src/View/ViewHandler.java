...
public class ViewHandler {
    ...
    private Region loadLoginView(String fxmlFile) {
        if (loginViewController == null) {
            try {
                ...
                loginViewController.init(this, root);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    private Region loadAddSeriesView(String fxmlFile) {
        if (addSeriesViewController == null) {
            try {
                ...
                addSeriesViewController.init(this, root);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    private Region loadHomePageView(String fxmFile) {
        try {
            ...
            homeScreenViewController.init(this, root);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return root;
    ...
    private Region loadSolarPanelEditView(String fxmFile) {
        if (solarPanelEditViewController == null) {
            try {
                ...
                solarPanelEditViewController.init(this, root);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    private Region loadModelDisplayView(String fxmFile) {
        if (modelDisplayViewController == null) {
            try {
                ...
                modelDisplayViewController.init(this, root);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    private Region loadModelEditView(String fxmFile) {
        if (modelEditViewController == null) {
            try {
                ...
                modelEditViewController.init(this, root);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
